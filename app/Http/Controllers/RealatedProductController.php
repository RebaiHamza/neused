...
class RealatedProductController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/reletdProduct')->with('updated', 'Related Product has been updated');
    ...
    public function setting_update(Request $request){
        ...
        return redirect('admin/reletdProduct_setting')->with('updated', 'Realated Setting has been updated');
    }
