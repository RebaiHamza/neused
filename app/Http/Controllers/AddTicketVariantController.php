...
class AddTicketVariantController extends Controller
{
    public function getPage($id)
    {
        ...
        return view('admin.ticketvariant.add', compact('findpro', 'proattr', 'getopts', 'copts'));
    }
    ...
    public function storeCommon(Request $request, $id)
    {
        ...
        return redirect()
            ->route('addticket.var', $id)->with('added', "Variant Added Successfully !");
    }
    ...
    public function delCommon(Request $request, $id)
    {
        ...
        return redirect()
            ->route('addticket.var', $cmvar->pro_id)
    ...
    public function destroy($id)
    {
        ...
        return back()->with('deleted', 'Ticket Variant Deleted !');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('addticket.var', $findpro->pro_id)
            ->with('updated', 'Ticket Values Updated Successfully !');
    }
}
