...
class VenderBidController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return DataTables::of($products)
                ...
                ->addColumn('price', 'admin.bidProduct.dtablecolumn.price')
                ...
                ->addColumn('status', 'seller.bidproduct.dtablecolumn.status')
                ->addColumn('history', 'seller.bidproduct.dtablecolumn.history')
                ->addColumn('action', 'seller.bidproduct.dtablecolumn.action')
                ->rawColumns(['checkbox', 'image', 'prodetail', 'price', 'catdtl', 'featured', 'status', 'history', 'action'])
                ->make(true);
        }

        return view("seller.bidproduct.index");
    }
    ...
    public function additionalPrice(Request $request)
    {
        ...
        if ($product) {
            return response()->json(['body' => View::make('admin.bidProduct.dtablecolumn.add_price_detail', compact('product'))->render()]);
        } else {
    ...
    public function allvariants($id)
    {
        ...
        return view('seller.bidproduct.allvar', compact('pro'));
    }

    public function importPage()
    {
        return view('seller.bidproduct.import');
    }
    ...
    public function create()
    {
        ...
        return view('seller.bidproduct.create', compact('auth_name', 'brands', 'categorys', 'vender_id'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('my.bidproducts.index')->with('success', 'Product created !');
    ...
    public function show_pro_image($id)
    {
        ...
        $stores = Store::where('user_id', auth()->id())
            ...
            ->get();
        $pro_image = DB::table('pro_images')->where('pro_id', $id)->get();
        return view("seller.bidproduct.edit_tab", compact('auth_name', 'stores', 'brands', 'categorys', 'vender_id', 'pro_image', 'products', 'child', 'grand'));
    }
    ...
    public function edit($id)
    {
        ...
        return view("seller.bidproduct.edit_tab", compact('rel_setting', "products", "categorys", "store", "brands", "faqs", "child", "grand", "realateds"));
    }
