...
class AddTicketSubVariantController extends Controller
{
    public function getIndex($id)
    {
        $findpro = Product::findorfail($id);
        return view('admin.ticketvariant.subvar', compact('findpro'));
    }
    ...
    public function post(Request $request, $id)
    {
        ...
        return redirect()
            ->route('addticket.var', $id)->with('added', 'Variant Linked Successfully !');
    ...
    public function edit($id)
    {
        ...
        return view('admin.ticketvariant.edit', compact('vars'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->stock != null) {
            ...
            if (isset($getusers)) {
                ...
                $msg2 = 'Buy Now Before stock goes again !';

                foreach ($getusers as $email) {
                    \DB::table('product_stock_subscription')->where('email', '=', $email->email)->delete();
                    Mail::to($email->email)->send(new ProductStockNotifications($vars, $msg2, $proname));
