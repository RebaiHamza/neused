<br>
   <form action="{{url('seller/bidproducts/')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        Bid Title: <span class="color-red" class="required">*</span>
                       </label>

                        <input required="" placeholder="Please enter bid title" type="text" id="first-name" autofocus="" name="name" value="{{ old('name') }}" class="form-control">
                      </div>
                    ...
                    <div class="col-md-6 margin-top-15">
                      ...
                      <div class="col-md-6 margin-top-15">
                         ...
                         <label>
                          ...
                          <input title="Offer price Format must be in this format : 200 or 200.25" pattern="[0-9]+(\.[0-9][0-9]?)?" required="" type="text" id="first-name" name="price" value="{{ old('price') }}" placeholder="Please enter bid price" class="form-control">
                      ...
                      <div id="manual_tax">
                       ...
                       <div class="col-md-12 margin-top-15">
                        ...
                        <div class="display-none" id="tax_class">
                          ...
                          <small class="txt-desc">(Please Choose Yes Then Start Sale This Bid )</small>
                    ...
                    <div class="col-md-4 margin-top-15">
                       ...
                       <small class="txt-desc">(If Enabled Then Free Shipping will enabled for this Bid) </small>
            ...
            Featured:
              ...
              <label class="tgl-btn" data-tg-off="No" data-tg-on="Yes" for="toggle-event2"></label>
                        ...
                        <small class="txt-desc">(If enabled than bid will be featured) </small>
                      </div>
                      ...
                      <div class="col-md-12 margin-top-15">
                        ...
                        <small class="txt-desc">(Please Choose Cash on Delivery Available On This bid or Not)</small>
                       </div>
                      ...
                      <div class="last_btn col-md-12">
                        ...
                        <div class="row">
                           ...
                           <label for="">Return Available :</label>
                            ...
                            <br>
                              <small class="text-desc">(Please choose an option that return will be available for this bid or not)</small>
