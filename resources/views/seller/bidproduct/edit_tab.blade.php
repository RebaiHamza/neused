...
@section('title',"Edit Bid: $products->name" )
@section('body')
  <div class="display-none" class="preL">
    ...
    <li role="presentation" class="active"><a href="#lis" aria-controls="home" role="tab" data-toggle="tab">Bid</a></li>
    
    <li role="presentation"><a href="#prospec" aria-controls="home" role="tab" data-toggle="tab">Bid Specification</a></li>
   
    <li role="presentation"><a href="#tags" aria-controls="messages" role="tab" data-toggle="tab">Faq</a></li>

    <li role="presentation"><a href="#rel" aria-controls="messages" role="tab" data-toggle="tab">Related Bid Setting</a></li>
    ...
    <div class="tab-content">
        ...
        <div role="tabpanel" class="tab-pane fade in active" id="lis">
            <div class="col-md-8">
               @include('seller/bidproduct/tab.edit.product') 
            </div>      
        </div>
        
        <div role="tabpanel" class="fade tab-pane" id="prospec">
            @include('seller.bidproduct.tab.edit.productspec') 
        </div>
         
         <div role="tabpanel" class="fade tab-pane" id="tags">
             @include('seller/bidproduct/tab.edit.faq') 
        </div>
        
        <div role="tabpanel" class="fade tab-pane" id="rel">
             @include('seller/bidproduct/tab.edit.show_related') 
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalCenterTitle">Bid Tax Information(PTI)</h4>
  ...
  <div class="modal-dialog model-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Related Bid for <b>{{ $products->name }}</b></h4>
      </div>
      <div class="modal-body">
        
          <form action="{{ route('rel.store',$products->id) }}" method="POST">
            @csrf
            <label>Choose Bids: <span class="required">*</span></label>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              ...
              <p>Do you really want to delete these Bids? This process cannot be undone.</p>
            </div>
            <div class="modal-footer">
