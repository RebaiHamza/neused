...
@section('title','Import Bid |')
@section("body")
	<div class="box box-primary">
		<div class="box-header with-header">
			<div class="box-title">Import Bids</div>
		</div>
		...
		<div class="box-body">
			...
			<table class="table table-striped">
				...
				<tbody>
					...
					<tr>
						<td>6</td>
						<td><b>Bid Name</b> (Required)</td>
						<td>Name of your Bid</td>
					</tr>

					<tr>
						<td>7</td>
						<td><b>Bid Description</b> (Optional)</td>
						<td>Detail of your Bid</td>
					</tr>

					<tr>
						<td>8</td>
						<td><b>Model</b> (Optional)</td>
						<td>Model No. of your Bid</td>
					</tr>
					...
					<tr>
						...
						<td>Your Bid price in currency (eg. INR,USD) </td>
					</tr>

					<tr>
						<td>11</td>
						<td><b>Price</b> (Required)</td>
						<td>Your Bid price (No string or comma in price)</td>
					</tr>

					<tr>
						<td>12</td>
						<td><b>Offer Price</b> [<b>Note:</b> Leave blank if you dont want offer price.]</td>
						<td>Your Bid offer price (No string or comma in price)</td>
					</tr>

					<tr>
						<td>13</td>
						<td><b>Featured</b> (Optional)</td>
						<td><p>Enable or disable Bid is featured or not.</p>
						<p>(Yes = 1, No = 0)</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable or disable Bid is active or not.</p>
						<p>(Yes = 1, No = 0)</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable cash on delivery on your Bid.</p>
						   <p>(Yes = 1, No = 0)</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable free shipping on your Bid.</p>
						   <p>(Yes = 1, No = 0)</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable Return available on your Bid.</p>
						   <p>(Yes = 1, No = 0)</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable Cancel available on your Bid.</p>
						   <p>(Yes = 1, No = 0)</p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable if you want to start selling your Bid from specific date.</p>
					...
					<tr>
						...
						<td><p>Enter if your Bid have warranty else enter <b>None</b>.</p>
						   <p><b>(eg. 1)</b></p>
						</td>
					</tr>
					...
					<tr>
						...
						<td><p>Enable if your Bid have warranty else enter <b>None</b>.</p>
					...
					<tr>
						...
						<td>Enter Bid tags by putting comma to seprate tags.</td>
					</tr>
