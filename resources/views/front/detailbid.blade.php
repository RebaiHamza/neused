                  ...
                  @foreach($value->pro->subvariants as $key=> $orivar)
                       @if($orivar->def ==1)
                          ...
                          @php 
                            ...
                            try{
                              $url = url('details-bid').'/'.$value->pro->id.'?'.$name[0]['attr_name'].'='.$var_name[0].'&'.$name[1]['attr_name'].'='.$var_name[1];
                            }catch(Exception $e)
                            {
                              $url = url('details-bid').'/'.$value->pro->id.'?'.$name[0]['attr_name'].'='.$var_name[0];
                            }
            ...
            @if(isset($relproduct))
                @foreach($relproduct->subvariants as $orivar)
                    ...
                    @if($orivar->def == '1')
                        ...
                        try{
                            $url = url('details-bid').'/'.$relproduct->id.'?'.$name[0]['attr_name'].'='.$var_name[0].'&'.$name[1]['attr_name'].'='.$var_name[1];
                        }catch(Exception $e)
                        {
                          $url = url('details-bid').'/'.$relproduct->id.'?'.$name[0]['attr_name'].'='.$var_name[0];
                        }
                      @endphp
          ...
          @if(isset($pro->subcategory->products))
                @foreach($relpro->subvariants as $orivar)
                    ...
                    @if($orivar->def == '1' && $pro->id != $orivar->products->id)
                        ...
                        try{
                          $url = url('details-bid').'/'.$relpro->id.'?'.$name[0]['attr_name'].'='.$var_name[0].'&'.$name[1]['attr_name'].'='.$var_name[1];
                        }catch(Exception $e)
                        {
                          $url = url('details-bid').'/'.$relpro->id.'?'.$name[0]['attr_name'].'='.$var_name[0];
                        }
                      @endphp
