@extends("front/layout.master") @php $sellerac = App\Store::where('user_id','=', $user->id)->first(); @endphp
@section('title','Apply For Seller Account |') @section("body")
  ...
  <div class="row">
    <div class="col-md-3">
      <div class="bg-white">
        ...
        <div align="center"> @if($user->image !="") <img src="{{url('images/user/'.$user->image)}}"
            class="user-photo" /> @else <img src="{{ Avatar::create(Auth::user()->name)->toBase64() }}"
            class="user-photo" /> @endif
          <h5>{{ $user->email }}</h5>
          ...
          <div class="wizard-card" data-color="orange" id="wizardProfile">
            <form method="post" enctype="multipart/form-data" action="{{url('store_vender')}}">
              ...
              <div class="wizard-header text-left">
                <h3 class="wizard-title">{{ __('staticwords.createStore') }}</h3>
              </div>
              <div class="wizard-navigation">
                <ul class="nav nav-tabs" role="tablist">
                  <li>
                    <a class="text-center" href="#about" role="tab" data-toggle="tab"> <i class="fa fa-user-o"
                        aria-hidden="true"></i> {{ __('staticwords.sellerinfo') }} </a>
                  </li>
                  <li>
                    <a class="text-center" href="#account" data-toggle="tab"> <i
                        class="{{session()->get('currency')['value']}}"></i> {{ __('staticwords.PaymentDetails') }} </a>
                  </li>
                  <li>
                    <a class="text-center" href="#cat" data-toggle="tab"> <i class="fa fa-comments-o"
                        aria-hidden="true"></i> {{ __('staticwords.SellerInterview') }} </a>
                  </li>
                </ul>
              </div>
              <div class="tab-content">
                  ...
                  <div class="row">
                    <div class="col-md-6 col-sm-6">
                      <div class="picture-container">
                        <div class="picture"> <img src="{{url('images/user.png')}}" class="picture-src img-fluid"
                            id="wizardPicturePreview" title="" />
                          <input type="file" name="store_logo" id="wizard-picture"> </div>
                        <h6>{{ __('staticwords.PleaseChooseStoreLogo') }}</h6>
                      </div> <span class="required">{{$errors->first('store_logo')}}</span>
                    </div>
                    <div class="col-md-6 col-sm-6">
                      <div class="form-group">
                        <label class="font-weight-bold">{{ __('staticwords.StoreName') }} <small
                            class="required">*</small></label>
                        <input type="hidden" id="first-name" name="user_id" class="form-control" value="{{$auth_id}}">
                        <input id="firstname" type="text" name="name" value="{{old('name')}}" class="form-control"
                          placeholder="{{ __('staticwords.Pleaseenterstorename') }}"> </div>
                      <div class="form-group">
                        <label class="font-weight-bold">{{ __('staticwords.Email') }} <small
                            class="required">*</small></label>
                        <input name="email" type="email" class="form-control" value="{{old('email')}}"
                          placeholder="{{ __('staticwords.eaddress') }}"> </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input pattern="[0-9]+" title="Invalid pincode" type="text" id="first-name"
                          ...
                          value="{{old('pin_code')}}" class="form-control" />
                        </div>
                      <br>
                      <br>
                      <div class="form-group">
                        <label class="font-weight-bold">{{ __('staticwords.StoreAddress') }} <small
                            class="required">*</small></label>
                        <input type="text" id="first-name" placeholder="{{ __('staticwords.PleaseEnterStoreAddress') }}"
                          name="address" value="{{old('address')}}" class="form-control"> <span
                          class="required">{{$errors->first('address')}}</span>
                      </div>
                      <div class="gap form-group">
                        <label class="font-weight-bold">{{ __('staticwords.MobileNo') }}
                          <small class="required">*</small></label>
                        <input title="Invalid mobile no" pattern="[0-9]+" type="text" id="first-name"
                          placeholder="{{ __('staticwords.PleaseEnterMobileNo') }} " name="mobile"
                          value="{{old('mobile')}}" class="form-control">
                        <p class="txt-desc"></p> <span class="required">{{$errors->first('mobile')}}</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="tab-pane" id="account">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="row">
                        <div class="form-group col-md-6">
                          ...
                          <div class="custom-control custom-checkbox">
                            <input onchange="valueChanged()" type="checkbox" class="paypal custom-control-input"
                              id="paypal" name="paypal" value="1">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="1" onchange="valueChanged()" name="paytem"
                              class="custom-control-input paytem" id="paytem">
                      ...
                      <div class="form-group">
                        <label class="font-weight-bold"> {{ __('staticwords.AccountNumber') }} <small
                            class="required">*</small></label>
                      ...
                      <div class="gap form-group">
                        <label class="font-weight-bold"> {{ __('staticwords.AccountName') }}: <small
                            class="required">*</small></label>
                      ...
                      <div class="gap form-group">
                        <label class="font-weight-bold"> {{ __('staticwords.BankName') }}: <small
                            class="required">*</small></label>
                      ...
                      <div class="gap form-group">
                        <label class="font-weight-bold"> {{ __('IFSC Code') }}: <small
                            class="required">*</small></label>
                      ...
                      <div class="gap form-group">
                        <label class="font-weight-bold">{{ __('staticwords.BranchAddress') }}: <small
                            class="required">*</small></label>
                      ...
                      <div class="gap form-group" id="paypal_email">
                        ...
                        <label class="font-weight-bold">{{ __('PayPal Email') }}: <small
                            class="required">*</small></label>
                        <input type="email" name="paypal_email" placeholder="Please Enter Paypal Email"
                          value="{{old('paypal_email')}}" class="form-control"> <span
                          class="required">{{$errors->first('paypal_email')}}</span> </div>
                      <div class="gap form-group" id="paytem_mobile">

                        <label class="font-weight-bold">{{ __('QPay Mobile Number') }}: <small
                            class="required">*</small></label>
                        <input pattern="[0-9]+" title="Invalid QPay No." type="text" name="paytem_mobile"
                          placeholder="Please Enter QPay Kyc Completed Mobile Number" value="{{old('paytem_mobile')}}"
                          class="form-control"> <span class="required">{{$errors->first('paytem_mobile')}}</span> </div>

                      <div class="gap form-group">
                        <label class="font-weight-bold">{{ __('staticwords.PreferredPaymentMethod') }}: <small
                            class="required">*</small></label>
                  ...
                  <div>
                    <div class="row form-group">
                      ...
                      <div class="col-md-4">
                        <div class="card-body">
                          <div class="custom-control custom-checkbox">
                            <input type="checkbox" value="{{$cat->title}}" name="vehicle[]" class="custom-control-input"
                              id="cat{{ $cat->id }}">
                ...
                <div class="wizard-footer">
                  <div class="pull-right"> <a id="abc" class='btn btn-next btn-fill btn-primary btn-wd'><i
                        class="fa fa-chevron-circle-right" aria-hidden="true"></i>{{ __('staticwords.Next') }}</a>
                    <button type="submit" class='btn btn-finish btn-fill btn-primary btn-wd'> <i class="fa fa-floppy-o"
                        aria-hidden="true"></i>{{ __('staticwords.Submit') }}</button>
                  </div>
                  <div class="pull-left">
                    <button type='button'
                      class='blackcolor btn btn-previous btn-default btn-wd' />{{ __('staticwords.Previous') }}</button>
                  </div>
      ...
      <div class="modal-body">
        <form id="form1" action="{{ route('pass.update',$user->id) }}" method="POST">
          ...
          <div class="form-group eyeCy">
            ...
            <input required="" minlength="8" id="confirm_password" type="password" class="form-control"
