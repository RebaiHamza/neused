...
<div class="box">
	<div class="box-header with-border">
		<div class="box-title">
			<a title="Go back" href="{{ url('admin/ticket-products') }}" class="btn btn-sm btn-default"><i class="fa fa-reply"
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="cmn">
						...
						<div class="box box-danger">
							<div class="box-header with-border">
								<div class="box-title">
									Add Common Ticket Variant For <b>{{ $findpro->name }}</b>
								</div>
					...
					<div role="tabpanel" class="tab-pane fade" id="home">
						...
						<div class="box box-danger">
							<div class="box-header with-border">
								<div class="box-title">
									Add Ticket Attributes For <b>{{ $findpro->name }}</b>
								</div>
						...
						<div class="box box-danger">
							<div class="box-header with-border">
								...
								<a class="btn btn-md btn-primary pull-right"
									href="{{ route('ticketmanage.stock',$findpro->id) }}">+ ADD
								</a>
							</div>
							...
							<div class="box-body">
								<table class="table table-striped">
									...
									<tr>
										...
										<td class="v-middle">
											<a title="Edit variant" href="{{ route('ticketedit.var',$sub->id) }}"
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ route('ticketcommon.update',$commonvariant->id) }}" method="POST">
					@csrf
	...
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form method="post" action="{{route('ticketdel.common',$commonvariant->id)}}" class="pull-right">
					{{csrf_field()}}
					{{method_field("DELETE")}}
...
<div id="edit{{ $opt->id }}" class="delete-modal modal fade" role="dialog">
	<div class="modal-dialog modal-md">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ route('ticketupdt.var2',$opt->id) }}" method="POST">
					{{ csrf_field() }}
...
<div id="{{ $opt->id }}var" class="delete-modal modal fade" role="dialog">
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form method="post" action="{{route('ticketdel.subvar',$opt->id)}}" class="pull-right">
					{{csrf_field()}}
					{{method_field("DELETE")}}
					<button type="reset" class="btn btn-gray translate-y-3" data-dismiss="modal">No</button>
					<button type="submit" class="btn btn-danger">Yes</button>
...
<div id="deletevar{{ $sub->id }}" class="delete-modal modal fade" role="dialog">
	<div class="modal-dialog modal-sm">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<form method="post" action="{{ route('ticketdel.var',$sub->id) }}" class="pull-right">
					{{csrf_field()}}
					{{method_field("DELETE")}}
					<button type="reset" class="btn btn-gray translate-y-3" data-dismiss="modal">No</button>
					<button type="submit" class="btn btn-danger">Yes</button>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
						aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalLabel">Add Ticket Common Variant</h4>
			</div>
			<div class="modal-body">
				<form action="{{ route('ticketadd.common',$findpro->id) }}" method="POST">
					{{ csrf_field() }}
...
<div class="modal fade" id="optionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form action="{{ route('ticketadd.str',$findpro->id) }}" method="POST">
					{{ csrf_field() }}
