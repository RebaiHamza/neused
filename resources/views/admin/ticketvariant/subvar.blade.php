...
@section("body")
	...
	<div class="box">
		...
		<div class="box-header with-border">
			<div class="box-title">
				Add Ticket Variant For <b>{{ $findpro->name }}</b>
			</div>
		</div>
  ...
  <!-- Nav tabs -->
    <form enctype="multipart/form-data" action="{{ route('ticketmanage.stock.post',$findpro->id) }}" method="POST">
						{{ csrf_field() }}
  ...
  <div class="col-md-12">
  	<a  href="{{ route('addticket.var',$findpro->id) }}" class="pull-right btn btn-md btn-default margin-left-15">
