      ...
      <div class="col-xs-12">
        ...
        <div class="box-header with-border">
          <h3 class="box-title"> Add Commision</h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{url('admin/commissionusedstore')}}" data-parsley-validate class="form-horizontal form-label-left">
                        {{csrf_field()}}
                      <div class="form-group">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12">
                          <select name="used_id" class="select2 form-control col-md-7 col-xs-12" id="country_id">
                          <option value="0">Please Choose</option>
                           ...
                           <small class="txt-desc">(Please Choose a used product)</small>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">
