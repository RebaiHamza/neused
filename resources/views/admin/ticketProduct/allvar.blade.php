	...
	<div class="box">
		...
		<div class="box-header with-border">
			<div class="box-title">
				...
				<a title="Go back to all tickets" href="{{ url('admin/ticket-products') }}" class="btn btn-sm btn-default"><i class="fa fa-reply" aria-hidden="true"></i></a> {{$pro->name}}'s Variant
