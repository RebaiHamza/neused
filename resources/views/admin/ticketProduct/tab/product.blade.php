<br>
   <form action="{{url('admin/ticket-products/')}}" method="POST" enctype="multipart/form-data">
                        {{csrf_field()}}
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <input required="" placeholder="Please enter ticket title" type="text" autofocus="" name="name" value="{{ old('name') }}" class="form-control">
                      </div>
