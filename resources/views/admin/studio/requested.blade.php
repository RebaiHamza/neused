...
@section('title','All Requested Pack Posts')
@section("body")
    ...
    <table id="full_detail_table" class="width100 table table-hover table-responsive">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            <a href=" {{url('admin/studio/'.$pack->id.'/edit')}} " class="btn btn-sm btn-info"><i
  ...
  <div class="modal-dialog modal-sm">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <p>Do you really want to delete this pack? This process cannot be undone.</p>
      </div>
