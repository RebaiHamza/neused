              ...
              <div class="box" >
                <div class="box-header">
                  <div class="box-title">Commission List</div>
                          ...
                          <a href=" {{url('admin/createbid')}} " class="btn btn-success pull-right">+ Add New Commission</a> 
                      </div>      
                      <div class="box-body">
                      ...
                      <tbody>
                        ...
                        <td>{{$i++}}</td>
                        @php
                            $bid_name = App\Product::where('id', '=', $commission->bid_id)->first();
                        @endphp
                        <td>{{$bid_name->name}}</td>
                        ...
                        <td>
                          <form action="{{ route('commission.quick.update',$commission->id) }}" method="POST">
                           ...
                           <td>
                            <div class="row">
                              <div class="col-md-2">
                                <a href=" {{url('admin/commissionbid/'.$commission->id.'/edit')}} " class="btn btn-sm btn-info">
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
                            ...
                            <form method="get" action="{{url('admin/commissionbiddestroy/'.$commission->id)}}" class="pull-right">
                              {{csrf_field()}}
                               {{method_field("DELETE")}}
